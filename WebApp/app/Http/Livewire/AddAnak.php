...
class AddAnak extends Component
{
    // Data yang di simpan
    public $nomor_siswa;
    public $nama_siswa;
    ...
    public function updated($fields)
    {
        $this->validateOnly($fields,[
            ...
            'checkup_id.required' => 'Data check up wajib di isi',
    ...
    public function AddAnak()
    {
        ...
        return redirect('/all-anak')->with('toast_success','Data anak berhasil ditambahkan');
    }

    public function render()
    {
        $checkups = Checkups::all();
        return view('livewire.add-anak',['checkups'=>$checkups])->layout('layouts.app');
    }
}
